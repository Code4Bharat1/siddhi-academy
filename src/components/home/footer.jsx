...
const Footer = () => {
  return (
    <footer className="bg-[#F2F2F2] text-black py-10 px-4">
      <div className="max-w-7xl mx-auto">

        {/* Logo for Mobile */}
        <div className="flex justify-center mb-6 lg:hidden">
          <img src="/logo.png" alt="Siddhi Academy Logo" className="h-16 w-auto" />
        </div>
        ...
        <div className="hidden lg:grid grid-cols-4 gap-10">
          ...
          <div className="flex flex-col items-center">
            <img src="/logo.png" alt="Siddhi Academy Logo" className="h-20 w-auto mt-5" />
          </div>
          ...
          <h3 className="font-semibold text-lg mb-1">Contact us</h3>
            <p className="space-y-1 text-md mb-2 mr-2">
              Address: <a href="https://www.google.com/maps?q=Yogiraj+Apartment,+Shop+No.+4,+Kishan+Nagar+3,+Wagle+Estate,+Thane+West+400604"
                target="_blank" rel="noopener noreferrer" className="text-black ">
                Yogiraj Apartment, Shop No. 4, Kishan Nagar 3, Wagle Estate, Thane West 400604
              </a>
            </p>
            <p className="text-md">
              Phone: <a href="tel:+918591870551" className="text-black ">+91 8591870551</a>
            </p>
            <p className="text-md">
              Email: <a href="mailto:siddhiacademy385@gmail.com" className="text-black ">siddhiacademy385@gmail.com</a>
            </p>
            ...
            <div className="flex items-center gap-2 mt-3">
              ...
              <a href="https://www.facebook.com/share/18dANBPSxk/" target="_blank" rel="noopener noreferrer">
                <img src="/facebook1.svg" alt="Facebook" className="h-10 w-10" />
              </a>
              <a href="https://www.instagram.com/siddhi.academy?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer">
                <img src="/instagram1.svg" alt="Instagram" className="h-10 w-10" />
              </a>
  ...
  <div className="text-sm ml-10">
    ...
    <div className="flex gap-3 mt-2">
      <a href="https://www.facebook.com/share/18dANBPSxk/" target="_blank" rel="noopener noreferrer">
        <img src="/facebook1.svg" alt="Facebook" className="h-8 w-8" />
      </a>
      <a href="https://www.instagram.com/siddhi.academy?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer">
        <img src="/instagram1.svg" alt="Instagram" className="h-8 w-8" />
      </a>
      <a href="https://www.linkedin.com/in/YOUR_LINKEDIN_ID" target="_blank" rel="noopener noreferrer">
        <img src="/linkedin1.svg" alt="LinkedIn" className="h-8 w-8" />
      </a>
    </div>
  </div>
</div>
